...
heartImage = love.graphics.newImage("hearttwo.png")
...
0 - math.random(chickenFace:getHeight(), chickenFace:getHeight() * 2)}
    ...
    local iw, ih = heartImage:getWidth(), heartImage:getHeight()

    f = math.random(0, w - iw)
    g = math.random(0, h - ih)
end
-------------------------------------------------
--MOUSE PRESS
...
love.graphics.draw(heartImage, f, g)
